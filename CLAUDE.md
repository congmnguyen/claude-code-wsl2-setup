...
**README preview assets**: Normalize every `assets/preview-*.png` to a 1220×788 canvas with `#0d1117` padding, and render it at `width="720"` in `README.md` so previews stay visually consistent.
